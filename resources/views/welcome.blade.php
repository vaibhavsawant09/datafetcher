...
<section class="w-full px-6 sm:px-8 text-gray-700 bg-white">
    <div class="container flex flex-col items-center justify-between py-4 mx-auto md:flex-row max-w-full">
        <div class="relative flex flex-col md:flex-row mb-4 md:mb-0">
            <a href="#_" class="flex items-center font-medium text-gray-900 lg:w-auto lg:items-center lg:justify-center">
                <span class="mx-auto text-xl font-black leading-none text-[#114A43] select-none">Wecares<span class="text-[#114A43]-600">.</span></span>
            </a>
        </div>
...
<section class="px-4 sm:px-8 py-16 bg-white">
    <div class="container items-center max-w-full px-8 mx-auto xl:px-5">
        <div class="flex flex-col sm:flex-row items-center sm:-mx-3">
            <!-- Left Text Section -->
            <div class="w-full sm:w-1/2 sm:px-3">
                <div class="space-y-6 sm:max-w-md lg:max-w-lg md:space-y-4 lg:space-y-8 xl:space-y-9">
                    <h1 class="text-3xl sm:text-4xl font-extrabold tracking-tight text-gray-900 sm:text-5xl md:text-4xl lg:text-5xl xl:text-6xl">
                        <span class="block xl:inline">Useful Tools to</span>
                        <span class="block xl:inline" style="color: #ffcc00;">Help You Build Faster.</span>
                    </h1>
                    <p class="mx-auto text-sm sm:text-base text-gray-500 sm:max-w-md lg:text-xl md:max-w-3xl">
            ...
            <div class="w-full sm:w-1/2 mt-8 sm:mt-0">
                <div class="w-full h-auto overflow-hidden rounded-md shadow-xl sm:rounded-xl">
                    <img src="https://parsio.io/_nuxt/image/8845ea.webp" alt="Image" class="w-full object-cover h-full">
                </div>
            </div>
        </div>
    </div>
...
<section class="bg-white">
    <div class="max-w-screen-xl px-4 py-12 mx-auto space-y-8 overflow-hidden sm:px-6 lg:px-8">
        ...
        <p class="mt-8 text-base leading-6 text-center text-gray-400">
            © 2021 Wecares India, Inc. All rights reserved.
        </p>
    </div>
</section>